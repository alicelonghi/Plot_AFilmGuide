...
public class activity_top_rated extends AppCompatActivity {
    ...
    public void init() {
        ...
        adapter = new MovieAdapter(activity_top_rated.this, movies);
    ...
    public void getToprated() {
        ...
        Call<Movie> movieCall = MDBapiService.getTopRated(ApiKey.API_KEY);
