...
public class Similares extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Intent intentSimilars = getIntent();
        String title_movie = getIntent().getExtras().getString("Title");
        //Toast.makeText(Similares.this, "Movie ID: " + movie_id, Toast.LENGTH_LONG).show();
        TextView textView_Title;
        textView_Title = findViewById(R.id.textView_Title);
        textView_Title.setText(title_movie +" - Similares");
    ...
    public void init() {
        ...
        adapter = new MovieAdapter(Similares.this, movies);
    ...
    public void getSimilars() {
        ...
        Integer movie_id = getIntent().getIntExtra("ID", 0);
        Call<Movie> movieCall = MDBapiService.getSimilars(Integer.toString(movie_id), ApiKey.API_KEY);
